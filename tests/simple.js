...
const s2 = "+pm=greenwich +ellps=GRS80 +a=6378137 +rf=298.257222101 +proj=tmerc +units=m +to_meter=1 +lat_0=0 +x_0=500000 +y_0=0 +lon_0=-105 +k_0=0.9996"
...
const source = 'PROJCS["NAD83(HARN) / UTM zone 13N",GEOGCS["datum: D_North_American_1983_HARN",DATUM["unknown",SPHEROID["GRS 1980",6378137,298.2572221010002,AUTHORITY["EPSG","7019"]]],PRIMEM["Greenwich",0],UNIT["degree",0.0174532925199433]],PROJECTION["Transverse_Mercator"],PARAMETER["latitude_of_origin",0],PARAMETER["central_meridian",-105],PARAMETER["scale_factor",0.9996],PARAMETER["false_easting",500000],PARAMETER["false_northing",0],UNIT["metre",1,AUTHORITY["EPSG","9001"]]]'
...
console.log(convert.forward([610500.02, 4650000]))
